...
const BLKBUF = asm { .gap 257 };
const TYPE_DIR = 0;
const TYPE_FILE = 0x100;
const DIRENTSZ = 16;

const SKIP_BLOCKS = 64; # to hold the kernel image
const ROOTBLOCK = 80;#SKIP_BLOCKS + 16; # skip the kernel image and the free-space bitmap
